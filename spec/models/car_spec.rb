...
RSpec.describe Car, type: :model do
  ...
  describe 'Class Methods' do
    before(:each) do
      @car1 = Car.create(make: 'Toyota', color: 'black', age: 2008)
      @car2 = Car.create(make: 'Hummer', color: 'silver', age: 2000)
      @car3 = Car.create(make: 'Ford', color: 'silver', age: 2015)
    end
    ...
    it 'should sort age :asc' do
      expect(Car.by_age).to eq([@car2, @car1, @car3])
    end
  end
